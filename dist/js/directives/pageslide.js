        ...
        function g(a) {
          ...
          if (n.bodyClass) {
            var b = n.className + "-body",
                c = new RegExp(b + "-closed|" + b + "-open");q.className = q.className.replace(c, "");var d = b + "-" + a;" " !== q.className[q.className.length - 1] ? q.className += " " + d : q.className += d;
          }
        }function i() {
          d.psOpen ? "function" == typeof d.onopen && d.$apply(d.onopen) : "function" == typeof d.onclose && d.$apply(d.onclose);
        }function j() {
